  ...
  return (
    <div className="border rounded-xl flex flex-col justify-evenly items-center w-11/12 mx-auto mb-8">
      <p className="text-center mt-8 font-bold text-2xl">HAPPY CLIENT'S</p>
        <div className="w-16 border-2 border-yellow-500 -ml-28"></div>
      ...
      <div className="flex gap-8 justify-evenly mt-6 mb-8">
        ...
        <div className="flex flex-col h-72 w-64 gap-4 border-2 p-2 justify-center items-center rounded-lg cursor-pointer transition-shadow duration-100 hover:shadow-2xl ">
          <img
        ...
        <div className="flex flex-col h-72 w-64 gap-4 border-2 p-2 justify-center items-center rounded-lg cursor-pointer transition-shadow duration-100 hover:shadow-2xl object-cover">
          <img
